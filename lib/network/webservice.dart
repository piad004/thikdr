...
class Webservice {
  ...
  Future<SkillModel> requestSkillList() async {
    final url = Uri.parse(baseUrl + "skils-list?role_id=4");
...
//var b = (jsonDecode(response.body)).toString();
  ...
  Future<SkillModel> requestLanguageList() async {
  ...
  Future<LeadDetailsModel> requestLeadsDetails(String token,String leadId) async {
  ...
  Future<CheckUserModel> requestBuyLeads(String token,String userId,String leadId,String transId,
      String price, String jsonValue,
      ) async {
  ...
  Future<CheckUserModel> requestEstimateItemAdd(String token,String name,String qty,String rate,
      String unit, String subtotal, String tax, String total,
      ) async {
