...
class _LeadDetailsState extends State<LeadDetailsPage> {
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Text(
                            "Category : " +
                                ((leadDetails.category != null)
                                    ? leadDetails.category.toString()
                                    : ""),
                            maxLines: null,
                            textAlign: TextAlign.left,
                        ...
                        Container(
                          ...
                          child: Text(
                            "Required For : " +
                                ((leadDetails.requiredFor != null)
                                    ? leadDetails.requiredFor.toString()
                                    : ""),
                            maxLines: null,
                            textAlign: TextAlign.left,
                        ...
                        Container(
                          ...
                          child: Text(
                            "Gross Lead Value : ₹ " +
                                ((leadDetails.estmdPrice != null)
                                    ? leadDetails.estmdPrice.toString()
                                    : ""),
                            maxLines: null,
                            textAlign: TextAlign.left,
                            style: AppStyle.textstylerobotoromanregular1017
                        ...
                        InkWell(
                          ...
                          child: Container(
                            ...
                            child: Text(
                              "Buy lead for ₹ " +
                                  ((leadDetails.salePrice != null)
                                      ? leadDetails.salePrice.toString()
                                      : "0"),
                              maxLines: 1,
                              textAlign: TextAlign.center,
                              style:
  ...
  makePayment()async {
    ...
    String orderAmount = leadDetails.salePrice.toString();
    ...
    if(cashfreePaymentStatus == "SUCCESS"){
      buyLeads(referenceId)
    },
    });
  }
    ...
    try {
      ...
      if (!leadModel.error) {
        Navigator.push(context,
            MaterialPageRoute(builder: (context) => MyLeadDetailsPage(leadDetails)));
      }
