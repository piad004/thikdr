  ...
  Widget build(BuildContext context) {
    ...
    child: TabBar(
      ...
      unselectedLabelColor: Colors.white.withOpacity(0.3),
          ...
          labelStyle: AppStyle.textstylerobotoromanregular1413,  //For Selected tab
          unselectedLabelStyle: AppStyle.textstylerobotoromanregular1413, //For Un-selected Tabs
